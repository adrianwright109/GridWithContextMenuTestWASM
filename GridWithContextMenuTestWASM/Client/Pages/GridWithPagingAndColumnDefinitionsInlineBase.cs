...
{
    public class GridWithPagingAndColumnDefinitionsInlineBase : ListVehiclesBase<SampleDataType2>
    {
        ...
        protected override async Task<IEnumerable<SampleDataType2>> RefreshAsyncMethod()
        {
            var dataItems = new List<SampleDataType2>();
            await Task.Delay(1000);//Simulate waiting for data to come through. 
            dataItems.AddRange(Enumerable.Range(1, 1000).Select(x => new SampleDataType2
            {
                Id = x,
                Name = "name " + x,
                Team = "team " + x % 5,
