...
{
    public class GridWithNoPagingBase : ListEntityBase<SampleDataType1>
    {
        ...
        protected override async Task<IEnumerable<SampleDataType1>> RefreshAsyncMethod()
        {
            var dataItems = new List<SampleDataType1>();
            await Task.Delay(1000);//Simulate waiting for data to come through. 
            dataItems.AddRange(Enumerable.Range(1, 1000).Select(x => new SampleDataType1
            {
                Id = x,
                Name = "name " + x,
                Team = "team " + x % 5,
